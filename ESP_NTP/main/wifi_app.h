...
#define WIFI_AP_SSID				"BeeM_Hub"			// AP name
#define WIFI_AP_PASSWORD			"PAss1020"			// AP password
#define WIFI_AP_CHANNEL				1					// AP channel b.k. ->1-11 2 and 3 not recommended
#define WIFI_AP_SSID_HIDDEN			0					// AP visibility
#define WIFI_AP_MAX_CONNECTIONS		5					// AP max clients
#define WIFI_AP_BEACON_INTERVAL		100					// AP beacon: 100 milliseconds recommended b.k. -> max 60000
#define WIFI_AP_IP					"192.168.50.1"		// AP default IP
#define WIFI_AP_GATEWAY				"192.168.50.1"		// AP default Gateway (should be the same as the IP)
